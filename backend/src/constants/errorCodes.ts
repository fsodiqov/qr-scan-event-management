export const ERROR_CODES = {
  ...
  ADMIN_LOGIN_EXISTS: 'ADMIN_LOGIN_EXISTS',
  EMAIL_REQUIRED_ADMIN: 'EMAIL_REQUIRED_ADMIN',
  LOGIN_REQUIRED_ADMIN: 'LOGIN_REQUIRED_ADMIN',
  ...
  ORG_USER_NOT_FOUND: 'ORG_USER_NOT_FOUND',
  ORG_USER_ALREADY_EXISTS: 'ORG_USER_ALREADY_EXISTS',
  CANNOT_REMOVE_LAST_OWNER: 'CANNOT_REMOVE_LAST_OWNER',
  SLUG_ALREADY_EXISTS: 'SLUG_ALREADY_EXISTS',
  SUBSCRIPTION_NOT_FOUND: 'SUBSCRIPTION_NOT_FOUND',
  PARTICIPANT_NOT_FOUND: 'PARTICIPANT_NOT_FOUND',
  PARTICIPANT_NOT_IN_EVENT: 'PARTICIPANT_NOT_IN_EVENT',
